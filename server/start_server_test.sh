...
mvn exec:java -Dexec.mainClass="edu.mit.csail.db.ml.main.Main" -Dexec.args="-conf ./src/main/resources/reference-test.conf" $THRIFT_VERSION &




# mvn clean compile && mvn exec:java -Dexec.mainClass="edu.mit.csail.db.ml.main.Main" -Dexec.args="-conf ./src/main/resources/reference-test.conf"

# -Dtest=TestFitEvent -Dthrift_version=0.9.3